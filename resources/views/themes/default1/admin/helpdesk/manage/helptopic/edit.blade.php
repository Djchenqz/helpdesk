        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                    {!! Form::label('department',Lang::get('lang.teams')) !!}
                    {!!Form::select('department', [''=>Lang::get('lang.select_a_team'),Lang::get('lang.teams')=>$teams->pluck('name','id')->toArray()],null,['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
