            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('grace_period') ? 'has-error' : '' }}">
                        ...
                        {!! Form::select('grace_period',['15'=>'15'.Lang::get('lang.min'), '60'=>'1'.Lang::get('lang.hours'), '360'=>'6'.Lang::get('lang.hours'), '720'=>'12'.Lang::get('lang.hours'), '1080'=>'18'.Lang::get('lang.hours'), '1440'=>'24'.Lang::get('lang.hours'), '2160'=>'36'.Lang::get('lang.hours'), '2880'=>'48'.Lang::get('lang.hours')],null,['class' => 'form-control']) !!}
                    </div>
                </div>
