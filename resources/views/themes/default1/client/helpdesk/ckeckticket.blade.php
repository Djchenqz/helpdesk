        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="pull-right">
                    ...
                    @if( $tickets->user_id == Auth::user()->id or Auth::user()->role == 'agent' or Auth::user()->role == 'admin' )
                    <div class="btn-group">
            ...
            <section class="content"  id="refresh" style="margin-bottom:-10px;margin-top:-10px">
                ...
                <div class="col-md-6">
                    <table class="table table-hover">
                        ...
                        <tr><td><b>{!! Lang::get('lang.teams') !!}:</b></td>
                            <?php
                            $help_topic = App\Model\helpdesk\Manage\Help_topic::where('id', '=', $tickets->help_topic_id)->first();
                            $department = App\Model\helpdesk\Agent\Teams::where('id', '=', $help_topic->department)->first();
                            ?>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $('#close').on('click', function (e) {
            $.ajax({
                type: "GET",
                url: "../ticket/user/close/{{$tickets->id}}",
                beforeSend: function () {
                    $("#refresh").hide();
                    $("#loader").show();
                },
