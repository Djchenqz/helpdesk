...
<div id="content" class="site-content col-md-12">
    <div id="corewidgetbox">
        ...
        @if(Auth::user())
            <span onclick="javascript: window.location.href='{{url('myorgatickets')}}';">
                <a href="{{url('myorgatickets')}}" class="widgetrowitem defaultwidget" style="background-image: URL('lb-faveo/media/images/orga.png');">
                    <span class="widgetitemtitle">{!! Lang::get('lang.org_tickets') !!}</span>
                </a>
            </span>
        @endif
