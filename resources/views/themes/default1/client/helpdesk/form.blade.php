    ...
    <div>
        ...
        <div class="row col-md-12">
            ...
            <div class="col-md-12 form-group {{ $errors->has('help_topic') ? 'has-error' : '' }}">
                ...
                if(Auth::user()){
                    ...
                    if($user_orga != null){
                        ...
                        $organization = App\Model\helpdesk\Agent_panel\Organization::where('id', '=', $orga_id)->first();
                        if ($organization != null && $organization->internal_notes != ''){
                            $user_orga_level = json_decode(str_replace('<br>', '', $organization->internal_notes))->type;
                        }
                    }
                }
                ?>
                <select name="helptopic" class="form-control" id="selectid">
                    ...
                    @if(in_array($user_orga_level, explode(',', $topic->internal_notes)))
           ...
           @endif
            ...
            <div class="col-md-12 form-group" id="filenames"></div>
            {{-- Event fire --}}
...
$(document).ready(function(){
   ...
   $("input[type=file]").on("change", function(e){
       var ipt_file = e.target;
       var arr = ["{!! Lang::get('lang.upload_file') !!}", ":<br>"];
       var files = ipt_file.files;
       for(var i=0; i<files.length;i++){
            arr.push(files[i].name);
            arr.push("<br>");
       }
       $("#filenames").html(arr.join(""));
   })
});
