                    ...
                    <div id="navbar" class="navbar-wrapper text-center">
                        <nav class="navbar navbar-default site-navigation" role="navigation">
                            <ul class="nav navbar-nav navbar-menu">
                                ...
                                @if($system->first()->status == 1 && Auth::user())
                                ...
                                <li @yield('myorgaticket')><a href="{{url('myorgatickets')}}">{!! Lang::get('lang.org_tickets') !!}</a></li>
                            ...
                            @else
                                <li @yield('login')><a href="{{URL::route('auth.login')}}">{!! Lang::get('lang.login') !!}</a></li>
                            </ul>
                            @if(false)
                            @if(isset($errors))
