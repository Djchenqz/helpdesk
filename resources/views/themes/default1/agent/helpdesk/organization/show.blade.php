...
<div class="row">
            ...
            <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
                    ...
                    @if($orgs->address)<li><a>
                            ...
                            <span class="pull-right">{!! $orgs->address !!}</span></a></li>@endif
                    @if($orgs->internal_notes)
			   
		        <li><a>
                            <b>{!! Lang::get('lang.sales') !!}</b>  
                            <span class="pull-right">{!! json_decode($orgs->internal_notes)->sales !!}</span></a></li>

			<li><a>
                            <b>{!! Lang::get('lang.PM') !!}</b>  
                            <span class="pull-right">{!! json_decode($orgs->internal_notes)->PM !!}</span></a></li>
			<li><a>
                            <b>{!! Lang::get('lang.SLA') !!}</b>  
                            <span class="pull-right">{!! json_decode($orgs->internal_notes)->SLA !!}</span></a></li>
			<li><a>
                            <b>{!! Lang::get('lang.Transfer') !!}</b>
				  
                           <!-- <span class="pull-right">{!! json_decode($orgs->internal_notes)->Transfer !!}</span></a></li>
			    --> 
					@switch(json_decode($orgs->internal_notes)->Transfer)
					@case(0)
	...
	<li><a>		
                            <b>{!! Lang::get('lang.type') !!}</b>  
                           <!-- <span class="pull-right">{!! json_decode($orgs->internal_notes)->type !!}</span></a></li> -->
			   <span class="pull-right">
				@switch(json_decode($orgs->internal_notes)->type)
				@case(0)
				    普通客户
				@break
				@case(1)
    ...
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">{{$orgs->name}} {!! Lang::get('lang.users_of') !!}</h3>
...
//        dd($open);
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                   {!! $orgs->name !!} {!! Lang::get('lang.report_of') !!}
                </h3>
            </div>
            <div class="box-body">
                <form id="foo">
