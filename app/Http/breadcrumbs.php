...
Breadcrumbs::register('ticket.user.close', function ($breadcrumbs) {
    $breadcrumbs->push(Lang::get('lang.close'), url('ticket/user/close/{id}'));
});
...
Breadcrumbs::register('ticket3', function ($breadcrumbs) {
    $breadcrumbs->push('My Organization Tickets', route('ticket3'));
});
